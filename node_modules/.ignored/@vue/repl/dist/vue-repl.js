...
import { g as getVersions, i as isVaporSupported, b as importMapFile, t as tsconfigFile, s as stripSrcPrefix, u as useStore } from './chunks/package-cWDyJnZu.js';
export { F as File, c as compileFile, v as languageToolsVersion, m as mergeImportMap, a as useVueImportMap } from './chunks/package-cWDyJnZu.js';
...
const SplitPane = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-a9fd0472"]]);
...
const Message = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-024df844"]]);
    ...
    async function updatePreview() {
      ...
      try {
        ...
        `
          ...
          if (response) {
            store.value.ssrOutput.html = String(response.ssrHtml ?? "");
            store.value.ssrOutput.context = response.ssrContext || "";
          }
        }
        ...
        if (mainFile.endsWith(".vue")) {
          codeToEval.push(
            `import { ${isSSR ? `createSSRApp` : `createApp`} as _createApp ${vaporSupported ? `, ${isSSR ? "createVaporSSRApp" : "createVaporApp"} as _createVaporApp` : ""} } from "vue"
...
const Sandbox = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-da180541"]]);
...
const _hoisted_1$4 = { class: "ssr-output" };
const _hoisted_2$3 = { class: "ssr-output-pre" };
const _hoisted_3$2 = { class: "ssr-output-pre" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        _cache[0] || (_cache[0] = createElementVNode("strong", null, "HTML", -1)),
        createElementVNode("pre", _hoisted_2$3, toDisplayString(_ctx.html), 1),
        _cache[1] || (_cache[1] = createElementVNode("strong", null, "Context", -1)),
        createElementVNode("pre", _hoisted_3$2, toDisplayString(_ctx.context), 1)
      ]);
    };
  }
});

const SsrOutput = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-23aca22a"]]);
...
const _hoisted_4$1 = {
  key: 0,
  class: "tab-buttons open-sourcemap"
};
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    showOpenSourceMap: { type: Boolean },
    showSsrOutput: { type: Boolean },
    ssr: { type: Boolean }
  },
  setup(__props, { expose: __expose }) {
    const props = __props;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createElementVNode("div", _hoisted_3$1, [
          ...
          mode.value === "ssr output" ? (openBlock(), createBlock(SsrOutput, {
            key: 0,
            context: unref(store).ssrOutput.context,
            html: unref(store).ssrOutput.html
          }, null, 8, ["context", "html"])) : mode.value !== "preview" ? (openBlock(), createBlock(props.editorComponent, {
            key: 1,
            readonly: "",
        ...
        showSourceMap.value ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
          createElementVNode("button", null, [
            createElementVNode("span", { onClick: openSourceMap }, "open sourceMap")
          ])
...
const Output = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d8257147"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: /* @__PURE__ */ mergeModels({
    ...
    showOpenSourceMap: { type: Boolean, default: false },
    showImportMap: { type: Boolean, default: true },
    showSsrOutput: { type: Boolean, default: false },
        ...
        createVNode(SplitPane, { layout: _ctx.layout }, {
          ...
          [outputSlotName.value]: withCtx(() => [
            createVNode(Output, {
              ...
              ssr: !!props.ssr
            }, null, 8, ["editor-component", "show-compile-output", "show-open-source-map", "show-ssr-output", "ssr"])
          ]),
          _: 2
        }, 1032, ["layout"])
      ]);
